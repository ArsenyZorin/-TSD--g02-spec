	...
	\begin{teststepmodel}
		...
		\begin{description}
			...
			\item[] \textbf{\hyperlink{actAdministrator.outactAdministrator.oeAddCoordinator}{actAdministrator.outactAdministrator.oeAddCoordinator} (AdtCoordinatorID, AdtLogin, AdtPassword, AdtPublicKey)}
		\end{description}}
