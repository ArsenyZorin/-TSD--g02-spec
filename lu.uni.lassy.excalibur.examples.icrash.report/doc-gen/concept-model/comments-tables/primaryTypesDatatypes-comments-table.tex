...
\adddoublerow{dtCoordinatorFirstName}{A string used to represent first names of coordinators.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid first name.}
...
\adddoublerow{dtCoordinatorLastName}{A string used to represent last name of coordinators.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid coordinators last name.}
...
\adddoublerow{dtEncodedPassword}{a encoded password byte array used to authentify an \msricrash user}
\addsingletwocolumnrow{extends}{dtByteArray}
\adddoubletwocolumnrow{operation}{\msrcode{eq():ptBoolean}}{used to determine if two encoded passwords a equals to each other}
...
\adddoublerow{dtPrivateKey}{a private key string used to encode a password of an \msricrash user}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{}
\adddoublerow{dtPublicKey}{a public key string used to decode a encoded password of an \msricrash user}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{}
\end{datadictionary}
