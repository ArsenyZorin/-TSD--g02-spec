...
\adddoubletwocolumnrow{operation}{\msrcode{init(Alogin:dtLogin, Apwd:dtPassword, ApubKey:dtPublicKey):ptBoolean}}{used to initialize the current object as a new instance of the ctAdministrator type.}
...
\adddoubletwocolumnrow{operation}{\msrcode{init(Alogin:dtLogin, Apwd:dtPassword, ApubKey:dtPublicKey):ptBoolean}}{used to initialize the current object as a new instance of the ctAuthenticated type.}
...
\addsingletwocolumnrow{extends}{icrash.concepts.primarytypes.classes.ctAuthenticated}
\adddoubletwocolumnrow{attribute}{\msrcode{firstName: dtCoordinatorFirstName}}{A string used to represent first names of coordinators.}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtCoordinatorID}}{a unique identification information.}
\adddoubletwocolumnrow{attribute}{\msrcode{lastName: dtCoordinatorLastName}}{A string used to represent last name of coordinators..}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtCoordinatorID, Alogin:dtLogin, Apwd:dtPassword, ApubKey:dtPublicKey):ptBoolean}}{used to initialize the current object as a new instance of the ctCoordinator type.}
...
\adddoublerow{ctKeyPair}{The class that stores pair of keys and allows to encode or decode a message}
\adddoubletwocolumnrow{operation}{\msrcode{decodeMsg(pwd:dtEncodedPassword, publicKey:dtPublicKey):ptBoolean}}{decodes encoded password}
