...
The \msrcode{init} operation has the following properties:
	...
	\addnumbereddoublerow{}{ApubKey: dtPublicKey}{used to initialize the public key field} 
	...
	\addnumberedsinglerow{PostF}{true if the system poststate includes the current object as a new ctCoordinator instance having its attributes equal to the ones provided as parameters.
	 }
