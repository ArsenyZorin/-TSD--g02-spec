...
The \msrcode{oeLogin} operation has the following properties:
	...
	\addnumbereddoublerow{}{AdtEncodedPassword: dtEncodedPassword}{second information used to determine accessibility rights for the actual actor.} 
	...
	\addnumberedsinglerow{PostF}{ if the login and encoded password provided by the actor correspond to the ones that belong to the ctAuthenticated instance he is related to 
	...
	postF{let TheSystem: ctState in
	  ...
	  let ctAuthPubKey:dtPublicKey in
	  
	  self.rnActor.rnSystem = TheSystem
	  and self.rnActor = TheactAuthenticated
	  and TheactAuthenticated.rnctAuthenticated.pubKey = ctAuthPubKey
	  
	  and /* PostF01 */
	      if (TheactAuthenticated.rnctAuthenticated.pwd
	          = TheSystem.rnCtKeyPair.decodeMsg(AEncodedPassword,ctAuthPubKey)
	...
	postP{ let TheSystem: ctState in
	  ...
	  and self.rnActor = TheactAuthenticated
	/* PostP01 */
	  if (TheactAuthenticated.rnctAuthenticated.pwd = ctKeyPairs.decodeMsg(AEncodedPassword)
